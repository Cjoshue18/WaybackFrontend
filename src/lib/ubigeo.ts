// Ubigeo Perú — departamentos → provincias → distritos (datos estáticos)
...
export const UBIGEO: UbigeoData = {
  'Amazonas': {
  ...
  'Áncash': {
    'Huaraz': ['Huaraz','Cochabamba','Colcabamba','Huanchay','Independencia','Jangas','La Libertad','Llanganuco','Pampas','Pato','Pira','Tarica'],
    ...
    'Carhuaz': ['Carhuaz','Acopampa','Amashca','Anta','Ataquero','Marcara','Pampamarca','San Miguel de Aco','Shilla','Tinco','Yungar'],
    ...
    'Huari': ['Huari','Anra','Cajay','Chavín de Huántar','Huacachi','Huacchis','Huachis','Huantar','Masin','Paucas','Ponto','Rahuapampa','Rapayan','San Marcos','San Pedro de Chaná','Uco'],
    ...
    'Recuay': ['Recuay','Catac','Cotaparaco','Huayllapampa','Llacllin','Marcapomacocha','Pampas Chico','Pampas Grande','Pátac','Punta Callán','Tapacocha','Turpay'],
    'Santa': ['Chimbote','Cáceres del Perú','Coishco','Macate','Moro','Nepeña','Samanco','Santa','Víctor Fajardo'],
  ...
  'Apurímac': {
    ...
    'Aymaraes': ['Chalhuanca','Capaya','Caraybamba','Chapimarca','Colcabamba','Cotaruse','Huayllo','Justo Apu Sahuaraura','Lucre','Pocohuanca','San Juan de Chiquinta','Sabayno','Sañayca','Soraya','Tapairihua','Tintay','Toraya','Yanaca'],
  ...
  'Huánuco': {
    ...
    'Ambo': ['Ambo','Cayna','Colpas','Conchamarca','Huacar','José Crespo y Castillo','Llata','San Francisco','San Rafael','Tomay Kichwa'],
    ...
    'Leoncio Prado': ['Tingo María','Daniel Alomia Robles','Hermilio Valdizán','José Crespo y Castillo','Luyando','Mariano Dámaso Beraún','Pucayacu','Castillo Grande','Pueblo Nuevo','Santo Domingo de Anda'],
  ...
  'Ica': {
    ...
    'Chincha': ['Chincha Alta','Alto Larán','Chavin','El Carmen','Grocio Prado','Chincha Baja','Pueblo Nuevo','San Juan de Yanac','San Pedro de Huacarpana','Sunampe','Tambo de Mora'],
  ...
  'La Libertad': {
    ...
    'Ascope': ['Ascope','Casa Grande','Chicama','Chocope','Guadalupito','Macabí Alto','Razuri','Santiago de Cao'],
    ...
    'Santiago de Chuco': ['Santiago de Chuco','Angasmarca','Cachicadan','Molebamba','Mollepata','Quiruvilca','Santa Cruz de Chuca','Sitabamba'],
    'Gran Chimú': ['Cascas','Lucma','Marmot','Sayapullo'],
    'Virú': ['Virú','Chao','Guadalupito'],
  },
  'Lambayeque': {
    'Chiclayo': ['Chiclayo','Cayaltí','Chongoyape','Eten','Eten Puerto','José Leonardo Ortiz','La Victoria','Lagunas','Monsefú','Nueva Arica','Oyotún','Patapo','Picsi','Pimentel','Reque','Santa Rosa','Saña','Zaña','Pomalca','Pucalá','Tumán'],
    'Ferreñafe': ['Ferreñafe','Cañaris','Incahuasi','Manuel Antonio Mesones Muro','Pitipo','Pueblo Nuevo'],
    'Lambayeque': ['Lambayeque','Chochope','Illimo','Jayanca','Mochumi','Mórrope','Motupe','Olmos','Pacora','Salas','San José','Tucume'],
  },
  'Lima': {
    'Lima': ['Barranco','Breña','Carabayllo','Chorrillos','Cieneguilla','Comas','El Agustino','Independencia','Jesús María','La Molina','La Victoria','Lima','Lince','Los Olivos','Lurigancho','Lurín','Magdalena del Mar','Miraflores','Pachacámac','Pucusana','Pueblo Libre','Puente Piedra','Punta Hermosa','Punta Negra','Rímac','San Bartolo','San Borja','San Isidro','San Juan de Lurigancho','San Juan de Miraflores','San Luis','San Martín de Porres','San Miguel','Santa Anita','Santa María del Mar','Santa Rosa','Santiago de Surco','Surquillo','Villa El Salvador','Villa María del Triunfo','Ate','Comas','Lurín','Ventanilla'],
    'Barranca': ['Barranca','Ámbar','Jaguar','Pativilca','Supe','Supe Puerto'],
    ...
    'Huaral': ['Huaral','Atavillos Alto','Atavillos Bajo','Aucallama','Chancay','Ihuarí','Lampián','Las Pampas','Pacaraos','San Miguel de Acos','Santa Cruz de Andamarca','Sumbilca','Veintisiete de Noviembre'],
    ...
    'Yauyos': ['Yauyos','Alis','Allauca','Ayavirí','Azángaro','Cachuy','Cañas','Cochas','Colonia','Hongos','Huampará','Huancaya','Huángascar','Huantán','Huañec','Laraos','Lincha','Madean','Miraflores','Omas','Putinza','Quinches','Quinocay','San Joaquín','San Pedro de Pilas','Tanta','Tauripampa','Tomas','Tupe','Viñac','Vitis'],
  },
  'Loreto': {
    ...
    'Putumayo': ['San Antonio del Estrecho','Horacia Zevallos','Huapapa','Rosa Panduro','Teniente Manuel Clavero','Yaguas'],
  },
  'Madre de Dios': {
  ...
  'Puno': {
    ...
    'Carabaya': ['Macusani','Ajoyani','Ayapata','Coaza','Corani','Crucero','Ituata','Ollachea','San Gabán','Usicayos'],
...
export function getDistritos(departamento: string, provincia: string): string[] {
  return (UBIGEO[departamento]?.[provincia] ?? []).slice().sort();
}
